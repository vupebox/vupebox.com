...
function () {
  ...
  regeneratorRuntime.mark(function _callee(req, res) {
    var userId, tokenData, role, validationRole, products, total, totalWithTax, totalEspenditure, totalExpenditureCancel, productsAgg, response;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 12:
            total = _context.sent;
            totalWithTax = total[0].total * 0.85;
            _context.next = 16;
          ...
          case 22:
            ...
            res.ok({
              total: totalWithTax - totalEspenditure[0].totalEspenditure + totalExpenditureCancel[0].totalExpenditureCancel,
              captures: response
            });
            _context.next = 31;
            break;
