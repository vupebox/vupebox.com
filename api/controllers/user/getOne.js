...
var _removePrivateData = function _removePrivateData(user) {
  var privateKeys = ['password'];
...
function () {
  ...
  regeneratorRuntime.mark(function _callee(req, res) {
    var userId, tokenData, role, validationRole, user;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            //const validationRole = await _validRole(role/*, tokenData, paramId*/);
          ...
          case 11:
            ...
            if (user) {
              res.ok(_removePrivateData(user));
            } else {
